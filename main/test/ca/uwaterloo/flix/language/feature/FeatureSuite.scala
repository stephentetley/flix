...
class FeatureSuite extends Suites(
  ...
  new FlixTest("Test.Expression.LetMatchStar", "main/test/ca/uwaterloo/flix/language/feature/Test.Expression.LetMatchStar.flix"),
  ...
  new FlixTest("TestTypeParameterElision", "main/test/ca/uwaterloo/flix/language/feature/TestTypeParameterElision.flix"),
  ...
  new FlixTest("Test.Predicate.Guard", "main/test/ca/uwaterloo/flix/language/feature/Test.Predicate.Guard.flix"),
  ...
  new FlixTest("Test.Term.Lit.Option", "main/test/ca/uwaterloo/flix/language/feature/Test.Term.Lit.Option.flix"),
  new FlixTest("Test.Term.Lit.Result", "main/test/ca/uwaterloo/flix/language/feature/Test.Term.Lit.Result.flix"),
  new FlixTest("Test.Term.Lit.Set", "main/test/ca/uwaterloo/flix/language/feature/Test.Term.Lit.Set.flix"),
