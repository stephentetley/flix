...
class LibrarySuite extends Suites(
  ...
  new FlixTest("TestStream", "main/test/ca/uwaterloo/flix/library/TestStream.flix")(Options.TestWithLibrary),
  ...
  new FlixTest("Pkger/TestSemVer", "main/test/ca/uwaterloo/flix/library/Pkger/TestSemVer.flix")(Options.TestWithLibrary)
)
